...
cat("Inital Cell count:", ncol(seurat_obj), "\n")

# Filter cells based on gene and transcript count
seurat_obj <- subset(seurat_obj,
                     subset = nFeature_RNA > 300 & nFeature_RNA < 6000 &
                       nCount_RNA > 100000 & nCount_RNA < 3000000)

cat("Remaining celll count:", ncol(seurat_obj), "\n")
